...
Tool count changes as upstream SDKs evolve. Verify the current runtime count with `tools/list` or the smoke test in [07. HTTP Endpoints, MCP Clients, And Smoke Tests](07_HTTP_ENDPOINTS_MCP_CLIENTS_SMOKE_TESTS.md).
