...
describe('createSapMcpServer', () => {
  it('registers the complete MCP tool surface without duplicates', async () => {
    ...
    expect(names.length).toBeGreaterThanOrEqual(351);
  ...
  it('exposes the modular tool catalog through bootstrap tools after registration', async () => {
    ...
    expect(quickContextPayload.summary).toContain('modules:21');
    expect(quickContextPayload.summary).toContain('catalogTools:177');
