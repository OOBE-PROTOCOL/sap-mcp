 ...
 * @description Vendored Adrena Anchor IDL (release/39) embedded as a TypeScript module.
 *
 * This file is auto-generated from the official Adrena IDL JSON at
 * https://github.com/AdrenaFoundation/adrena-abi (commit pinned in adrena-constants.ts).
 * It is embedded directly in the TypeScript source so that `tsc` includes it
 * in the compiled output without requiring a separate file copy step.
 *
