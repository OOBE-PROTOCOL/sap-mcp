...
| Adrena perps trading | \`sap_adrena_build_open_long\`, \`sap_adrena_build_open_short\`, \`sap_adrena_build_position_package\`, \`sap_adrena_build_close_long\`, \`sap_adrena_build_close_short\`, \`sap_adrena_build_set_stop_loss\`, \`sap_adrena_build_set_take_profit\`, \`sap_adrena_build_add_liquidity\`, \`sap_adrena_build_swap\`, \`sap_adrena_build_add_limit_order\` |
