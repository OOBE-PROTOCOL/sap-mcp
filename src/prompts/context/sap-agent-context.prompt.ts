...
- Prefer the local \`sap_payments_call_paid_tool\` bridge with \`maxAttempts\` for hosted paid/write tools when the runtime cannot natively replay x402 challenges. \`sap_x402_paid_call\` is a legacy alias.
