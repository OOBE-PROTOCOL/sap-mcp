...
describe('release readiness documentation and package surface', () => {
  ...
  it('documents company-grade branch boundaries, service contracts, and release personas', () => {
    ...
    expect(readText('src/core/types.ts')).toContain('toolCatalog?: SapMcpToolCatalogContext');
    expect(readText('src/tools/register-tools.ts')).toContain('context.toolCatalog = summarizeToolCatalog');
    expect(readText('src/tools/tool-execution-pipeline.ts')).toContain('registerPipelineTool');
    expect(readText('src/tools/tool-family-pipeline.ts')).toContain('registerToolFamilyPipelineTool');
    expect(readText('src/tools/tool-family-pipeline.ts')).toContain('ToolFamilyPipelineResult');
    expect(readText('src/tools/tool-family-pipeline.ts')).toContain('parseStringToolPayload');
    expect(readText('src/tools/sap-network-stats.tool.ts')).toContain('registerPipelineTool');
    expect(readText('src/tools/agent-start-tool.ts')).toContain('toolCatalog: context.toolCatalog ?? null');
    expect(readText('src/tools/quick-context-tool.ts')).toContain('toolCatalog: context.toolCatalog ?? null');
    ...
    expect(readText('src/remote/index.ts')).toContain('RemoteMCPServer');
    expect(readText('src/remote/index.ts')).toContain('buildPublicToolCatalogDocument');
    expect(readText('src/local-bridge/index.ts')).toContain('startStdioTransport');
    expect(readText('src/local-bridge/index.ts')).toContain('getPaymentBridgeProcessStatus');
    ...
    expect(readText('src/tools/module-registry.ts')).toContain('must declare packageName provenance');
    expect(readText('src/tools/module-registry.ts')).toContain('must declare version provenance');
    expect(readText('src/tools/module-registry.ts')).toContain('must declare expectedTools sentinels');
    expect(readText('src/tools/module-registry.ts')).toContain('must use namespace prefix');
    ...
    expect(readText('src/wizard-core/desktop-flow.ts')).toContain('getDesktopHostedDiscovery');
    ...
    expect(readText('src/config/runtime-doctor.ts')).toContain('buildDoctorReport');
    expect(readText('src/config/runtime-doctor.ts')).toContain('buildActiveDoctorReport');
    expect(readText('src/config/runtime-doctor.test.ts')).toContain('external-signer');
    expect(readText('src/config/index.ts')).toContain("runtime-doctor.js");
    expect(readText('src/config-cli.ts')).toContain('Machine-readable readiness report');
    expect(readText('src/wizard-core/desktop-flow.ts')).toContain('/.well-known/sap-mcp-tool-catalog.json');
    ...
    expect(readText('src/tools/quick-context-tool.ts')).toContain('registerToolFamilyPipelineTool');
    expect(readText('src/tools/estimate-tool-cost.ts')).toContain('registerToolFamilyPipelineTool');
    expect(readText('src/tools/sap-sdk-tools.ts')).toContain('registerSapPipelineTool');
    expect(readText('src/tools/sap-sdk-tools.ts')).toContain('registerToolFamilyPipelineTool');
    expect(readText('src/tools/sap-sns-tools.ts')).toContain('registerSnsPipelineTool');
    expect(readText('src/tools/sap-sns-tools.ts')).toContain('registerToolFamilyPipelineTool');
    expect(readText('src/tools/client-sdk-tools.ts')).toContain('registerClientSdkPipelineTool');
    expect(readText('src/tools/client-sdk-tools.ts')).toContain('registerToolFamilyPipelineTool');
    expect(readText('src/tools/magicblock-tools.ts')).toContain('magicBlockUiCardFromMetadata');
    expect(readText('src/tools/magicblock-tools.ts')).toContain('registerToolFamilyPipelineTool');
    expect(readText('src/tools/adrena/adrena-pipeline.ts')).toContain('registerAdrenaPipelineTool');
    expect(readText('src/tools/adrena/adrena-pipeline.ts')).toContain('adrenaPipelineException');
    expect(readText('src/tools/adrena/adrena-data-tools.ts')).toContain('registerAdrenaPipelineTool');
    expect(readText('src/tools/adrena/adrena-snapshot-tools.ts')).toContain('registerAdrenaPipelineTool');
    expect(readText('src/tools/adrena/adrena-liquidity-tools.ts')).toContain('registerAdrenaPipelineTool');
    expect(readText('src/tools/adrena/adrena-limit-order-tools.ts')).toContain('registerAdrenaPipelineTool');
    expect(readText('src/tools/adrena/adrena-commodity-tools.ts')).toContain('registerAdrenaPipelineTool');
    expect(readText('src/tools/adrena/adrena-staking-tools.ts')).toContain('registerAdrenaPipelineTool');
    expect(readText('src/tools/adrena/adrena-trading-tools.ts')).toContain('registerAdrenaPipelineTool');
    expect(readText('src/tools/transaction-tools.ts')).toContain('registerTransactionPipelineTool');
    expect(readText('src/tools/transaction-tools.ts')).toContain('registerToolFamilyPipelineTool');
    expect(readText('src/tools/chat-tools.ts')).toContain('registerChatPipelineTool');
    expect(readText('src/tools/chat-tools.ts')).toContain('registerToolFamilyPipelineTool');
    expect(readText('src/tools/agent-start-tool.ts')).toContain('registerAgentStartPipelineTool');
    expect(readText('src/tools/agent-start-tool.ts')).toContain('registerToolFamilyPipelineTool');
    expect(readText('src/tools/profile-tools.ts')).toContain('registerProfilePipelineTool');
    expect(readText('src/tools/profile-tools.ts')).toContain('registerToolFamilyPipelineTool');
    expect(readText('src/tools/premium-tools.ts')).toContain('registerPremiumPipelineTool');
    expect(readText('src/tools/premium-tools.ts')).toContain('registerToolFamilyPipelineTool');
    expect(readText('src/tools/memory-tools.ts')).toContain('registerMemoryPipelineTool');
    expect(readText('src/tools/memory-tools.ts')).toContain('createStringToolPipelineResult');
    expect(readText('src/tools/skills-tools.ts')).toContain('registerSkillsPipelineTool');
    expect(readText('src/tools/skills-tools.ts')).toContain('registerToolFamilyPipelineTool');
    expect(readText('src/tools/x402-paid-call-tool.ts')).toContain('registerX402PipelineTool');
    expect(readText('src/tools/x402-paid-call-tool.ts')).toContain('createStringToolPipelineResult');
    expect(readText('src/tools/builtin-tool-modules.ts')).toContain("'sap_payments_fund_prepaid'");
    expect(readText('src/tools/builtin-tool-modules.ts')).toContain("'sap_update_agent'");
    expect(readText('src/tools/builtin-tool-modules.ts')).toContain("'magicblock_swap_quote'");
    expect(readText('src/tools/skills-tools.ts')).toContain("writeFileSync(destination, file.content");
    expect(readText('src/tools/skills-tools.ts')).toContain('Refusing to install skill file outside targetDir');
    expect(readText('src/tools/tool-execution-pipeline.ts')).toContain('createUiCardResponse');
    expect(readText('src/tools/tool-execution-pipeline.ts')).toContain('createToolExecutionResult');
    expect(readText('src/tools/sap-network-stats.tool.ts')).toContain('createToolExecutionResult');
    ...
    expect(readText('config/tool-execution-pipeline-contracts.json')).toContain('"minimumPipelineToolRegistrations": 165');
